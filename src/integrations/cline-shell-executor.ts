...
function containedRequest(command: string | ClineStructuredCommandInput, cwd: string) {
  ...
  if (typeof command === "string") {
    ...
    return { executable: "/bin/bash", args: ["-c", command], cwd, writablePaths: [cwd] };
  }
