// GENERATED from mcp-toolbox/packages/result-bounds/src/index.ts — do not edit by hand.
// Drift is enforced by packages/result-bounds/src/vendor-drift.test.ts.
