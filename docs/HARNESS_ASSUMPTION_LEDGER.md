...
provenance: that research doc is operator-local and uncommitted in this branch — merge-time action: commit it with the citing changes, canonical copy not duplicated here).
