...
- **Honest motion.** The only authored motion moments are the working-dot pulse, toggle transitions, and short color/border transitions; the pulse, toggle tracks, and chip transitions stop under `prefers-reduced-motion`.
